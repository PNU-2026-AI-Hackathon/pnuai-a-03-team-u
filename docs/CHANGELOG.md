...
**발견 경위**: 팀원이 "관리회계(서민근)"·"AI비즈니스(홍태호)" 두 과목을 시간표에 담았는데 주간
그리드에 안 뜬다고 보고. `course_offerings`를 직접 조회해보니 두 과목 다 `course_times`
행이 아예 없었다.
...
1,474/4,340(34%) → 3,455/4,341(80%), 시간 세션 5,202개 신규 파싱, 관리회계·AI비즈니스
